...
![Gatsby](../images/blog/on_relearning_to_code/gatsby_homepage.png "Gatsby")
...
![Styled Components homepage](../images/blog/on_relearning_to_code/styled_components_homepage.png)
...
<ArticleMedia caption="In case you missed them">
    <video autoPlay muted loop className="has-shadow">
        <source src="/blog/on_relearning_to_code/site_animations.mp4" type="video/mp4" />
    </video>
</ArticleMedia>
...
![Bedsheet on my wall](../images/blog/on_relearning_to_code/bedsheet.jpg)
