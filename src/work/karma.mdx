...
<ArticleMedia caption="Karma's updated store and switching Pulse tiers">
...
<ArticleMedia caption="Karma's updated billing screen and an example out-of-data state">
...
<ArticleMedia caption="Karma's updated usage screen">
...
<ArticleMedia caption="Signed in dashboard with expanded usage graphs">
...
<ArticleMedia caption="The second, simpler version of Karma's pricing page">
